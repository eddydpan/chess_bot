...
def pick_and_place(xy_initial, xy_final, height, clearance_height, client, gripper_width=1):
    ...
    time.sleep(4)
    client.move(np.array([x_initial, y_initial, clearance_height+height, 0, 1.5, 0]))
    time.sleep(4)
    client.move(np.array([x_initial, y_initial, height, 0, 1.5, 0]))
    time.sleep(4)
    client.move_gripper(0.0)
    time.sleep(4)
    client.move(np.array([x_initial, y_initial, clearance_height+height, 0, 1.5, 0]))
    time.sleep(4)
    client.move(np.array([x_final, y_final, clearance_height+height, 0, 1.5, 0]))
    time.sleep(4)
    client.move(np.array([x_final, y_final, height, 0, 1.5, 0]))
    client.move(np.array([x_final, y_final, height+placing_droop+0.002, 0, 1.5, 0]))
    time.sleep(4)
...
def main():
    ...
    pick_and_place([0.45, 0], [0.375, 0], 0.023, 0.08, client, gripper_width=0.7)

    pick_and_place([0.375, 0], [0.3, 0], 0.023, 0.08, client, gripper_width=0.7)

    pick_and_place([0.3, 0], [0.225, 0], 0.023, 0.08, client, gripper_width=0.7)
